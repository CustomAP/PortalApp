...
public class MisAdapter extends RecyclerView.Adapter<MisAdapter.DataHolder> {
    ...
    class DataHolder extends RecyclerView.ViewHolder implements RecyclerView.OnClickListener {
        ...
        private ImageView pna; //ImageView added

        DataHolder(View itemView) {
            super(itemView);

            //Initialisation of all objects should be done at same place.
            ...
            pna = (ImageView) itemView.findViewById(R.id.pna);

            //Typeface not looking good thats why temporarily commented.
        ...
        public void onClick(View v) {
            if (!absent) {
                ...
                //Setting ImageDrawable
                pna.setImageDrawable(v.getResources().getDrawable(R.drawable.green_circle_background));
                //text not required, either text or graphics(color is used)
                /*paText.setText("P");
                ...
                //Setting ImageDrawable
                pna.setImageDrawable(v.getResources().getDrawable(R.drawable.red_circle_background));
                //text not required, either text or graphics(color is used)
                /*paText.setText("A");
